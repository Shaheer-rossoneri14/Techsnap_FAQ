"""
Django settings for techsnap_faq project.
...
ALLOWED_HOSTS = ['https://techsnap-faq.herokuapp.com/', '127.0.0.1']
...
ROOT_URLCONF = 'techsnap_faq.urls'
...
WSGI_APPLICATION = 'techsnap_faq.wsgi.application'
